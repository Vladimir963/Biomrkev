...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(Biomrkev.getName() +", narozen: " + Biomrkev.getBorn() +", jezdící v autě se SPZ: " + Biomrkev.getRegnumber() + " a žijící v obci " + Biomrkev.getCity() + ", prodal průměrně " + Biomrkev.getTotalWeight()/Biomrkev.getNumberOfContracts()+" tun biomrkve.");
